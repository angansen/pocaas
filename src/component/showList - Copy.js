                        ...
                        if (myObj[n].TF_VAR_Ip != '') {
                            if (myObj[n].TF_VAR_StatusMsg == 'RUNNING') {
                                if (myObj[n].TF_Var_SolutionID == "8") {
                                    var actionBtn = '<button  class="launchbtnADWC Yes" alt="' + myObj[n].TF_Var_SolutionID + '" data-field="' + myObj[n].login_status + '" type="' + myObj[n].TF_VAR_id + '"> Launch </button>&nbsp;&nbsp;<button class="deletebtn No deleteYes" type="' + myObj[n].TF_VAR_id + '" alt="' + myObj[n].TF_Var_SolutionID + '"> Delete </button>';
                                } else {
